    ...
    >
      <div
        className={cn(
          ...
          sticky
            ? "bg-white/95 dark:bg-[#0b0c0e]/95 md:bg-transparent backdrop-blur supports-[backdrop-filter]:backdrop-blur md:backdrop-blur-0 border-t md:border-0 border-neutral-200/80 dark:border-neutral-800/30"
            : ""
        )}
      >
